            ...
            try
            {
                ...
                if (position >= 0)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        else if (item.Id == 10)//Monthly pay status
                        {
                            StartActivity(new Intent(this, typeof(SettingPayStatusActivity)));
                        }
                        else if (item.Id == 11)//Setting Epsilon Card Detail
                        {
                            StartActivity(new Intent(this, typeof(SettingCardDetailActivity)));
                        }
                    }
                }
            }
