    ...
    public class SettingGeneralActivity : AppCompatActivity 
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                FollowPriceEditText = FindViewById<EditText>(Resource.Id.followPrice);
                ...
                SetColorEditText(FollowPriceEditText);
            ...
            try
            {
                if (Methods.CheckConnectivity())
                {
                    ...
                    if (!string.IsNullOrEmpty(EmailEditText.Text))
                     ...
                     if (!string.IsNullOrEmpty(FollowPriceEditText.Text))
                        dictionary.Add("following_price", FollowPriceEditText.Text);
                    ...
                    if (dictionary.Count > 0)
                    {
                        ...
                        if (respondCode == 200)
                        {
                            ...
                            if (dataUser != null)
                            {
                                ...
                                dataUser.Following_Price = FollowPriceEditText.Text;                                
